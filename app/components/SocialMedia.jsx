...
export default function SocialMedia() {
  return (
    <div className="hero-two-area hero-area-three mb-10">
            ...
            <div className="swiper hero-info-slide">
              ...
              <div className="hero-slide-control w-100 d-flex flex-column mt-lg-5 mt-3">
                <div className="hero-number-pagination d-flex align-items-center justify-content-between pe-lg-2">
                  ...
                  <div className="hero-img-fraction-pagination text_black fnt-weight-500"></div>
                </div>
                <div className="hero-img-pagination d-flex justify-content-md-end mt-3 flex-wrap gap-2">
                  <div className="hero-images d-none">
                    <span data-image-url="/images/hero/hero-slide-dot-1.png"></span>
                    <span data-image-url="/images/hero/hero-slide-dot-2.png"></span>
                    <span data-image-url="/images/hero/hero-slide-dot-3.png"></span>
                    <span data-image-url="/images/hero/hero-slide-dot-4.png"></span>
                  </div>
                </div>
              </div>
